...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DjangoFrontendIntegrations.Employee();
  });
  ...
  describe('Employee', function() {
    it('should create an instance of Employee', function() {
      ...
      //var instance = new DjangoFrontendIntegrations.Employee();
      //expect(instance).to.be.a(DjangoFrontendIntegrations.Employee);
    });
